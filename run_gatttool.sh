...
# Get Humidity
send -i $orig "char-write-req 0x3C 01:00\r"
expect -i $orig "written successfully"
send -i $orig "\r\rchar-write-req 0x39 01:00\r"
expect -i $orig "written successfully"
